<?php
    include '../../Models/Sleeping_BagDB.php';
    $product = getSleeping_BagById($_GET['id']);
    session_start();
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="product_info">
                        ...
                        <div class="add_to_cart">
                            <button class="btn_add">
                                <a href="../../index.php?page=sleeping_bag&function=add_to_cart&id=<?php echo $product['Id']; ?>"> Add To Cart</a>                               
                            </button>
                        </div>
                    </div>
                    <style>
