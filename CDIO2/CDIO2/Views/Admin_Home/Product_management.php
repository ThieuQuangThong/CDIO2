...
<body>
    <div class="total_page">
        ...
        <div class="content">
                ...
                <ul>
                    <li class="collection-item">
                        ...
                        <div class="collection-content">
                            <h2>Fishing</h2>
                            <div class="shop">
                                <a href="./Product_management.php" class="hv">
                                    SHOP
            ...
            <div class="fishing">
                <h1>Fishing</h1>
                <a href="../Fishing/Insert_Fishing.php">Add new Fishing rob</a>
                <div class="fish-item">
                            ...
                            <?php foreach ($products as $product) : ?>
                                <div class="cols col__4">
                                    ...
                                    <button  class="prd__btn">
                                        <a href="../Fishing/Update_fishing.php?id=<?php echo $product['Id'] ?>">Update</a>
                                        <a href="../../index.php?function=remove_fishing&id=<?php echo $product['Id'] ?>">Delete</a>
                                    </button>
                                </div>
                            <?php endforeach; ?>
                        </tbody>
        ...
        <h3 class="text_h3">About us search term of service refund policy</h3>
